...
**Next Session Action:** pick a thread.
- **Redesign:** RD-5 — sweep Finance/Trading/Tools/Cooking/Contact + breadcrumbs inside the new shell, patch glaring clashes; then RD-6 — real-browser verify (theme-morph + a screenshot; the live clock blocks the headless preview from settling) + ship.
