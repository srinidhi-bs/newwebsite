...
const CookingPaneerGheeRoast = lazy(() => import('../pages/CookingPaneerGheeRoast'));
...
const SIPComparisonCalculatorPage = lazy(() => import('../pages/SIPComparisonCalculatorPage'));
    ...
    <AnimatePresence mode="wait">
      ...
      */}
      <Routes location={location} key={location.pathname}>
        ...
        <Route path="/cooking/paneer-ghee-roast" element={withErrorBoundary(<CookingPaneerGheeRoast setCurrentPage={setCurrentPage} />)} />
